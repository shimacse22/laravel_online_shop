...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('page.update', $page->id) }}" method="post" name="pageForm" id="pageForm">
                @method('put')
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('name', $page->name) }}" type="text" name="name"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('slug', $page->slug) }}" type="text" name="slug"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea value="{{ old('content', $page->content) }}" name="content" id="content" class="summernote" cols="30"

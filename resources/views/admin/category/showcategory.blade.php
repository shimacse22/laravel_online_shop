                ...
                <form action ="" method="get">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route('category.show') }}' "
                                ...
                                @foreach ($categories as $cat)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($cat->category_img != '')
                                                <img width="50"
                                                    src="{{ asset('upload/category-images/' . $cat->category_img) }}"
                                                    alt="">
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            <form id="delete-product-from-{{ $cat->id }}"

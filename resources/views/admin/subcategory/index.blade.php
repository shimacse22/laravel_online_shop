                ...
                <form action ="" method="get">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route('subcategory.index') }}' "
                                ...
                                @foreach ($subcategories as $subcategory)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form id="delete-subCategory-from-{{ $subcategory->id }}"
...
<script>
    function deletesubCategory(id) {
        if (confirm("Are you sure you want to delete this category?")) {
            document.getElementById("delete-subCategory-from-" + id).submit();
        }
    }
</script>
@section('customJS')

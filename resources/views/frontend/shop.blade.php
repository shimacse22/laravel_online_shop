                                    ...
                                    @if ($categories->isNotEmpty())
                                        @foreach ($categories as $key => $category)
                                            <div class="accordion-item">
                                                ...
                                                @else
                                                    <a href="{{ route('front.shop', $category->category_slug) }}"
                                                        class="nav-item nav-link {{ $categorySelected == $category->id ? 'text-primary' : '' }}">{{ $category->category_name }}</a>
                                                @endif
                                                @if ($category->subCategory->isNotEmpty())
                                                        ...
                                                        <div class="accordion-body">
                                                            <div class="navbar-nav">
                                                                @foreach ($category->subCategory as $subCategory)
                                                                    <a href="{{ route('front.shop', [$category->category_slug, $subCategory->slug]) }}"
...
@section('customJS')
    <script>
        ...
        //from this slider we find ionRangeSlider max & min value

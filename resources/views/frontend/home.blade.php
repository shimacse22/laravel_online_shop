                ...
                <div class="carousel-inner">
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset="{{ asset('frontend-assets/images/banner-image1-m.jpg') }}" />
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('frontend-assets/images/banner-image1.jpg') }}" />
                            <img src="images/banner-image1.jpg" alt="" />
                        </picture>
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3">
                                <h1 class="display-4 text-white mb-3">Stylish Furniture & Decor</h1>
                    ...
                    <div class="carousel-item active">
                        <picture>
                            ...
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('frontend-assets/images/banner-image2.jpg') }}" />
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            ...
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('frontend-assets/images/banner-image3.jpg') }}" />
                            ...
                            <div class="col-lg-3">
                                <div class="cat-card">
                                    <div class="left">
                                        ...
                                        @else
                                            <img src="{{ asset('upload/category-images/thumb/' . $category->category_img) }}"
                                                alt="" class="img-fluid">
                                        @endif
                                    </div>
                                    <div class="right">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card product-card">
                                    <div class="product-image position-relative">
                                        ...
                                        <a class="whishlist" href="javascript:void();"
                                            onclick="addToWishList(event, {{ $product->id }})"><i
                                                class="far fa-heart"></i></a>
